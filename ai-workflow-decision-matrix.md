...
This note complements `software-engineering-in-the-age-of-ai.md`, `ai-native-governance.md`, `ai-team-role-changes.md`, `ai-native-sdlc.md`, and `ai-tools-by-sdlc-phase.md`.
